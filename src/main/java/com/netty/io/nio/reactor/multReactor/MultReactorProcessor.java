 ...
 * @author 86136
 */
public class MultReactorProcessor {
    private static final Logger LOGGER = LoggerFactory.getLogger(MultReactorProcessor.class);
    private static final ExecutorService service = Executors.newFixedThreadPool(2 * Runtime.getRuntime().availableProcessors());

    private Selector selector;

    public MultReactorProcessor() throws IOException {
