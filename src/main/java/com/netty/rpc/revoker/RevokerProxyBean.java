...
import com.netty.rpc.cluster.engine.ClusterEngine;
 ...
 * @author 86136
 */
public class RevokerProxyBean implements InvocationHandler {
    ...
    public RevokerProxyBean(Class<?> targetInterface, int consumeTimeout, String clusterStrategy) {
    ...
    public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
        ...
        //获取某个接口的服务提供者列表
        RegisterCenterInvoker registerCenter4Consumer = RegisterCenterInvoker.singleton();
        ...
        try {
            ...
            if (fixedThreadPool == null) {
                synchronized (RevokerProxyBean.class) {
